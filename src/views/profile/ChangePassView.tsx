...
import type { UpdateCurrentUserPassForm } from "@/types/index";
import { useMutation } from "@tanstack/react-query";
import { changePass } from "@/api/ProfileAPI";
import { toast } from "react-toastify";

export default function ChangePassView() {
  const initialValues: UpdateCurrentUserPassForm = {
    current_password: '',
    password: '',
  ...
  const handleChangePassword = (formData: UpdateCurrentUserPassForm) => mutate(formData);
